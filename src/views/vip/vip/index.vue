      ...
      <el-form :inline="true" :model="txVipStore.searchForm" class="searchForm" label-position="right"
        ...
        <el-row>
          <el-form-item label="咸鱼名称" prop="xyName">
            <el-input v-model="txVipStore.searchForm.xyName" placeholder="请输入咸鱼名称" clearable @keyup.enter="refresh" />
          </el-form-item>
          <el-form-item label="起始时间" prop="startingTime">
            <el-date-picker clearable v-model="txVipStore.searchForm.startingTime" type="date" value-format="YYYY-MM-DD"
              placeholder="请选择起始时间"></el-date-picker>
          </el-form-item>
          <el-form-item label="结束时间" prop="stopingTime">
            <el-date-picker clearable v-model="txVipStore.searchForm.stopingTime" type="date" value-format="YYYY-MM-DD"
              placeholder="请选择结束时间"></el-date-picker>
          </el-form-item>
          <el-form-item label="开通天数" prop="purchaseDays">
            <el-input v-model="txVipStore.searchForm.purchaseDays" placeholder="请输入开通天数" clearable
              @keyup.enter="refresh" />
          </el-form-item>
          <el-form-item label="设备名称" prop="unitType">
            <el-input v-model="txVipStore.searchForm.unitType" placeholder="请输入设备名称" clearable @keyup.enter="refresh" />
          </el-form-item>
          <el-form-item label="登录方式" prop="loginMethod">
            <el-input v-model="txVipStore.searchForm.loginMethod" placeholder="请输入登录方式" clearable
              @keyup.enter="refresh" />
          </el-form-item>
...
const deleteItem = (item: any) => {
  txVipStore.del(item.vipId).then(() => {
    refresh()
  })
}
...
const deleteItems = () => {
  ...
  const vipIds = txVipStore.multipleSelection
    .map((item: any) => item.vipId)
    .join(',')

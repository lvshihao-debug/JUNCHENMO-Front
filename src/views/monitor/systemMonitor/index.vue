      ...
      <el-row :gutter="10">
        <el-col :span="6">
          <JcmInfoCard
            iconName="服务器"
            title="系统信息"
            :infoData="systemMonitorStore?.baseInfo?.server"
          />
        </el-col>
        <el-col :span="6">
          <JcmInfoCard
            iconName="cpu"
            title="系统CPU"
            :infoData="systemMonitorStore?.baseInfo?.cpu"
          />
        </el-col>
        <el-col :span="6">
          <JcmInfoCard
            iconName="内存"
            title="系统内存"
            :infoData="systemMonitorStore?.baseInfo?.memory"
          />
        </el-col>
        <el-col :span="6">
          <JcmInfoCard
            iconName="内存"
            title="JVM内存"
            :infoData="systemMonitorStore?.baseInfo?.jvmMemory"
          />
        </el-col>
      </el-row>
      <el-row :gutter="10">
        <el-col :span="24">
          ...
          <el-card class="card-table-style">
            <vxe-table
              border="inner"
              height="345"
              :data="systemMonitorStore?.baseInfo?.processes"
              empty-text="没有更多数据了！"
        ...
        <el-col :span="24">
          ...
          <el-card class="card-table-style">
            <vxe-table
              border="inner"
              height="200"
              :data="systemMonitorStore?.baseInfo?.fileSystem"
              empty-text="没有更多数据了！"
              :scroll-y="{ enabled: true, gt: 0 }"
            >

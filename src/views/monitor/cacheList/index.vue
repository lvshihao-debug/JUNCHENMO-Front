      ...
      <el-col :span="8">
        ...
        <el-card class="card-table-style">
          <vxe-table
            ...
            height="550"
            width="100%"
            :data="cacheListStore.dictData"
            align="center"
            empty-text="没有更多数据了！"
            @cell-click="cacheNameClick"
            ...
            <vxe-column field="flag1" title="操作" width="80">
              <template #default="{ row }">
                <el-button
                  size="small"
                  type="primary"
                  @click.stop="deleteCacheNameClick(row.value)"
                  text
                >
                  删除
                </el-button>
      ...
      <el-col :span="8">
        ...
        <el-card class="card-table-style">
          <vxe-table
            border="inner"
            height="550"
            :data="cacheListStore.cacheNameData"
            empty-text="没有更多数据了！"
            :scroll-y="{ enabled: true, gt: 0 }"
            @cell-click="cacheNameKeyClick"
          >
            <vxe-column type="seq" width="70"></vxe-column>
            <vxe-column
              field="keyName"
            ...
            <vxe-column field="flag1" title="操作" align="center" width="80">
              <template #default="{ row }">
                <el-button
                  size="small"
                  type="primary"
                  @click.stop="deleteCacheKeyClick(row.keyName)"
                  text
                >
                  删除
                </el-button>
        ...
        <el-card class="card-table-style">
          ...
          >
            ...
            <el-form-item label="缓存键名" prop="nickname">
              <el-input
                v-model="cacheListStore.viewData.cachekeyName"
                disabled
              />
            </el-form-item>
            <el-form-item
            ...
            <!-- json 查看器模态框 -->
            <editor
              v-model="cacheListStore.viewData.context"
              readonly="true"
              height="390px"

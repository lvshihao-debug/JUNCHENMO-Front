      ...
      <el-row :gutter="10">
        <el-col :span="6">
          <JcmInfoCard
            :iconName="'服务器'"
            :title="'服务信息'"
            :infoData="cacheMonitorStore?.baseInfo?.server"
          />
        </el-col>
        <el-col :span="6">
          <JcmInfoCard
            :iconName="'内存'"
            :title="'内存信息'"
            :infoData="cacheMonitorStore?.baseInfo?.memory"
          />
        </el-col>
        <el-col :span="6">
          <JcmInfoCard
            :iconName="'状态'"
            :title="'状态信息'"
            :infoData="cacheMonitorStore?.baseInfo?.stats"
          />
        </el-col>
        <el-col :span="6">
          <JcmInfoCard
            :iconName="'数据库'"
            :title="'DB 0 信息'"
            :infoData="cacheMonitorStore?.baseInfo?.db0"
          />
        </el-col>
      </el-row>
      <el-row :gutter="10">
        <el-col :span="6">
          <JcmInfoCard
            :iconName="'其他'"
            :title="'其他信息'"
            :infoData="cacheMonitorStore?.baseInfo?.other"
          />
        </el-col>
        <el-col :span="6">
          <JcmInfoCard

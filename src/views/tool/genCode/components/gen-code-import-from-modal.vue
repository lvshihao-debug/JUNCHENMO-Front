<template>
    <el-dialog v-model="fromOpenStatus" width="800" :show-close="false">
            ...
            <el-form :inline="true" :model="genCodeStore.tableSearchForm" class="searchForm" label-position="right"
                ...
                <el-row>
                    ...
                    <div style="margin-left: auto" class="card-search-end">
                        <JcmButton :buttonBgColor="layoutSettingStore.getTheme"
        ...
        <el-card class="card-table-style">
            <el-table :data="genCodeStore.tableDataList.list" table-layout="auto" @selection-change="handleSelectionChange">
            ...
            <template #footer>
                <div class="pagination-style">
                    ...
                    <el-pagination :page-sizes="[10, 20, 30, 40]" small="small" background="true"
                        ...
                        layout="total, sizes, prev, pager, next, jumper" :total="genCodeStore.tableDataList.total"
        ...
        <template #footer>
            <div class="modal-style">
                ...
                <el-button type="primary" text bg @click="addItem()">
                    确认
                </el-button>
            </div>
        </template>
...
const refresh = () => {
    ...
    (instance?.proxy as any).$addPage(searchQuery, genCodeStore.tableDataList.page, genCodeStore.tableDataList.size);
...
const addItem = async () => {
    ...
    const tableNames = genCodeStore.tableMultipleSelection.map((item: any) => item.tableName).join(",")

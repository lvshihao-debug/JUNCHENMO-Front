<template>
  <div class="fade">
    <el-card class="searchCard">
      <el-form
        :inline="true"
        :model="sysJobLogStore.searchForm"
        class="searchForm"
      ...
      >
        <el-row>
          ...
          <el-form-item label="任务组名" prop="jobGroup">
            <el-select
              v-model="sysJobLogStore.searchForm.jobGroup"
              placeholder="请选择任务组名"
              clearable
            >
              <el-option
          ...
          <el-form-item prop="taskTimeRange" label="执行时间">
            <el-date-picker
              v-model="jobTaskExecuteTimeRange"
              type="datetimerange"
              range-separator="-"
          ...
          <el-form-item v-show="more" label="执行状态" prop="jobGroup">
            <el-select
              v-model="sysJobLogStore.searchForm.status"
              placeholder="请选择执行状态"
              clearable
            >
              <el-option
    ...
    <el-card class="card-table-style">
      <el-table
        :data="sysJobLogStore.dataList.list"
        table-layout="auto"
      ...
      <template #footer>
        <div class="pagination-style">
          ...
          <el-pagination
            ...
            :total="sysJobLogStore.dataList.total"
...
const deleteItem = (item: any) => {
  sysJobLogStore.del(item.jobLogId).then(() => {
    refresh()
  })
}
...
const deleteItems = () => {
  ...
  const jobLogIds = sysJobLogStore.multipleSelection
    .map((item: any) => item.jobLogId)
    .join(',')

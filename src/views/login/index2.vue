    ...
    <el-col :span="8" :xs="24" :offset="1">
      <el-row id="from">
        <div class="form-card" style="z-index: 2">
          ...
          <div style=" margin-bottom: 20px;font-size: 13px; color: #595959">
            The reverse determines the height, and the development determines
            the depth
          </div>
          <el-form
            ref="ruleLoginRef"
...
.code-img {
  border-radius: 3px;
  filter: drop-shadow(0 0 3px #334de3) !important;
  cursor: pointer;
}

<template>
  <div>
    <div class="login-container">
      <!--logo位置-->
      <div
        class="logo-div-jcm selector-disabled animate__animated animate__flipInX"
      >
        <div>
      ...
      <div class="login-card animate__animated animate__bounceInLeft">
        <div
          class="column animate__animated animate__fadeIn"
          style="width: 400px"
        >
          <el-row>
            <el-col :span="24">
              <div class="form-card">
                <div class="title">RBAC管理系统</div>
                <div class="describe">
                  The reverse determines the height, and the development
        ...
        <div
          class="column animate__animated animate__slideInRight"
          style="width: 400px"
        ></div>
      </div>
    </div>

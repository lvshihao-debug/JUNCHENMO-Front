<template>
  <div class="fade">
    ...
    <el-card class="card-table-style">
      ...
      >
        ...
        <el-table-column prop="username" label="用户名" align="center">
          <template #default="scope">
            <span
              @click="(instance?.proxy as any).$copyText(scope.row.username)"
              class="copy-span"
            >
              {{ scope.row.username }}
            </span>
        ...
        <el-table-column align="center" label="操作">
          <template #default="scope">
            ...
            <el-button
              size="small"
              type="primary"
              @click="userUpdateFromModal?.open(scope.row)"
              text
            >
              修改
            </el-button>
            ...
            <template v-if="!isAdminById(scope.row.userId)">
              <el-button
                size="small"
                type="primary"
                @click="userRestPasswordFromModal?.open(scope.row)"
                text
              >
                重置密码
              </el-button>
            ...
            <template v-if="!isAdminById(scope.row.userId)">
              <el-button
                size="small"
                type="primary"
                @click="userAuthRolesFromModal?.open(scope.row)"
                text
              >
                分配角色
              </el-button>
      ...
      <template #footer>
        <div class="pagination-style">
          ...
          <el-pagination
            ...
            :total="userStore.dataList.total"
    ...
    <UserRestPasswordFromModal
      ref="userRestPasswordFromModal"
    ></UserRestPasswordFromModal>
    <UserAuthRolesFromModal
      ref="userAuthRolesFromModal"
    ></UserAuthRolesFromModal>
  </div>
</template>

<template>
  <div class="fade">
      ...
      <template #footer>
        <div class="pagination-style">
          ...
          <el-pagination
            ...
            :total="roleStore.dataList.total"
    ...
    <RoleAuthMenusFromModal
      ref="roleAuthMenusFromModal"
    ></RoleAuthMenusFromModal>
...
//删除多个字典类型触发的事件
const deleteItems = () => {
  const roleIds = roleStore.multipleSelection

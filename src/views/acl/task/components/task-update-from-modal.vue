<template>
    ...
    <el-dialog v-model="fromOpenStatus" width="500" :show-close="false">
        ...
        <el-form :model="sysUserTaskStore.commonForm" label-width="80" ref="formRef" :rules="formRules">
            ...
            <el-form-item label="用户名称" prop="userId">
                <el-select v-model="sysUserTaskStore.commonForm.userId" placeholder="请输入执行任务的用户" clearable>
                    <el-option v-for="user in sysUserTaskStore.userOptions" :key="user.userId" :label="user.username"
                        :value="user.userId" />
                </el-select>
            </el-form-item>
        </el-form>

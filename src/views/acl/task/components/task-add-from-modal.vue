<template>
    <el-dialog v-model="fromOpenStatus" width="500" :show-close="false">
        ...
        <el-form :model="sysUserTaskStore.commonForm" label-width="80" :rules="formRules" ref="formRef">
            <el-form-item label="任务标题" prop="title">
                <el-input v-model="sysUserTaskStore.commonForm.title" placeholder="请输入任务标题" />
            </el-form-item>
            <el-form-item label="任务描述" prop="description">
                <el-input v-model="sysUserTaskStore.commonForm.description" type="textarea" placeholder="请输入内容" />
            </el-form-item>
            ...
            <el-form-item label="优先级" prop="priority">
                <el-select v-model="sysUserTaskStore.commonForm.priority" placeholder="请选择任务优先级">
            ...
            <el-form-item label="状态" prop="status">
                <el-select v-model="sysUserTaskStore.commonForm.status" placeholder="请选择任务状态">
                    <el-option v-for="dict in loadDictDataByName('taskStatus')" :key="dict.value"
                        :label="dict.description" :value="parseInt(dict.value)"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="类型" prop="type">
                <el-select v-model="sysUserTaskStore.commonForm.type" placeholder="请选择任务类型">
                    <el-option v-for="dict in loadDictDataByName('taskType')" :key="dict.value"
                        :label="dict.description" :value="parseInt(dict.value)"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="用户名称" prop="userId">
                <el-select v-model="sysUserTaskStore.commonForm.userId" placeholder="请输入执行任务的用户" clearable>

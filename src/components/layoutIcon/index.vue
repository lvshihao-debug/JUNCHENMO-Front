<template>
  <div class="jcm-layout-icon">
    <div
      class="layout-icon-container"
      :style="{
        backgroundColor: leftBgColor,
        border:
          currentSelectedIndex == index ? '3px solid ' + themeColor : theme,
      }"
    >
      <div
        :class="['left-column', { 'custom-width': customLeftWidth }]"
      ...
      <div
        :class="['right-column', { 'custom-width': customRightWidth }]"
...
watch(
  () => layoutSettingStore.setting.themeColor,
  (newVal) => {
